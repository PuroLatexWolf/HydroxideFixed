...
local web = true
local user = "PuroLatexWolf" -- change if you're using a fork
...
local globalMethods = {
    ...
    getContext = getthreadcontext or get_thread_context or (syn and syn.get_thread_identity) or getthreadidentity,
    ...
    isXClosure = isexecutorclosure or is_synapse_function or issentinelclosure or is_protosmasher_closure or is_sirhurt_closure or iselectronfunction or istempleclosure or checkclosure,
